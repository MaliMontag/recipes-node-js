...
| Recipes | GET | `/recipes/prep-time/:minutes` | No | List public recipes up to prep time |
...
| Categories | GET | `/categories/with-recipes` | No | Get all categories with recipes |
| Categories | GET | `/categories/:identifier` | No | Get category by code or description with recipes |
